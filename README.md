...
Scalable, transactional and low latency real-time data updates for Golang, wrapped in one very simple API built on top of [Neogate](https://github.com/Liphium/neogate).
